    ...
    <footer className="bg-black pt-16 pb-12 border-t border-white/10">
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-16">
          ...
          <FooterColumn
            title="Company"
            links={['About LineraHost', 'Research', 'Open Source', 'Careers', 'Changelog', 'Governance', 'Community', 'Grants']}
          />
          <FooterColumn
            title="Social"
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-[#0070f3] font-medium">LineraHost Network Status: All Workers Online.</span>
          </div>
