        ...
        <div className="min-h-screen bg-black text-white selection:bg-[#0070f3] selection:text-white pb-20">
            ...
            <div className="max-w-4xl mx-auto px-6 pt-32 pb-16">
                ...
                <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-accents-4 mb-6">
                    Understanding LineraHost Function Deployment
                </h1>
                <p className="text-xl text-accents-5 mb-12 leading-relaxed">
                    Learn how to build, structure, and deploy unstoppable serverless functions on the LineraHost network.
                </p>
                ...
                <div className="space-y-16">
                    ...
                    <section>
                        ...
                        <div className="prose prose-invert max-w-none text-accents-4">
                            ...
                            <p>
                                ...
                                LineraHost takes your code, distributes it across a global network of workers, and executes it on-demand when a user visits your URL.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="prose prose-invert max-w-none text-accents-4 mb-6">
                            <p>
                                To deploy on LineraHost, your GitHub repository must follow a simple structure.
                    ...
                    <section>
                        ...
                        <div className="prose prose-invert max-w-none text-accents-4 mb-6">
                            <p>
                                A LineraHost function is just a standard JavaScript file. It doesn't need to export anything special.
...
return {
    ...
    body: {
        message: \`Hello, \${name}! from LineraHost\`,
        timestamp: Date.now()
    }
};`}
                            </pre>
                    ...
                    <section>
                        ...
                        <div className="prose prose-invert max-w-none text-accents-4">
                            <ol className="list-decimal list-inside space-y-4">
                                ...
                                <li>
                                    <strong className="text-white">Deploy!</strong> formatting LineraHost will bundle your code, upload it to IPFS, and register it on the blockchain.
                                </li>
                            </ol>
                        </div>
                    </section>
